...
const Signin = () => {
    ...
    return (
        <div className="xl:flex h-screen bg-bg1">
            <div className="xl:w-[719.988px] xl:inline-block hidden">
                <svg 
                ...
                <div className="xl:flex xl:mt-[357px] xl:ml-[144.5px] xl:h-auto xl:w-[299px] xl:items-center xl:justify-between xl:relative">
                    <img className="xl:relative xl:w-[44px] xl:h-[44px]"
                         src="./images/Vector1.svg"
                         alt="Vector" />
                    <img className="xl:relative xl:w-[42px] xl:h-[41px]"
                         src="./images/Vector2.svg"
                         alt="Vector" />
                    <img className="xl:w-[48px] xl:relative xl:h-[48px]"
                         src="./images/Vector3.svg"
                         alt="Vector" />
                    <img className="xl:w-[50px] xl:relative xl:h-[48px]"
            ...
            <div className="h-full flex flex-col items-center xl:items-start xl:justify-normal justify-center">
                <div className="xl:ml-[93.19px] w-auto">
                    ...
                    <div className="xl:mt-[28.54px] mt-10 flex md:flex-row max-xs:flex-col">
                        <div>
                            <div className="md:w-[197.596px] max-xs:w-[360px] w-[198px] h-[34px] xl:h-[32.933px] flex-shrink-0 flex items-center justify-center z-[1] bg-white rounded-lg xl:shadow-none max-xs:shadow-md cursor-pointer" onClick={handleGoogleAuth}>
                            <img className="w-[15.369px] h-[15.369px] flex-shrink-0 xl:mt-[8.78px] xl:mb-[8.78px] xl:ml-[20.86px] mr-[10.98px]" src="./images/Vector5.svg" alt="" />
                        ...
                        <div className="md:ml-[27.44px] max-xs:ml-0">
                            ...
                            <img className="w-[12.624px] h-[15.369px] flex-shrink-0 xl:mt-[8.78px] xl:mb-[8.78px] xl:ml-[20.86px] mr-[10.98px]" src="./images/Vector6.svg" alt="Vector" />
                            <span className="flex md:w-[129.535px] h-[16.466px] flex-col justify-center flex-shrink-0">
                                <span className="text-secondary-text align-middle font-montserrat md:text-[12px] max-xs:text-[15px] font-normal">
                                    Sign in with Apple
                                </span>
                    ...
                    <div className="md:w-[422.635px] max-xs:w-[360px] h-[347.988px] flex-shrink-0 rounded-[20px] bg-white mt-[35.13px] xl:shadow-none max-xs:shadow-xl">
                        <form className="flex flex-col pl-[32.93px] pt-[32.93px] md:pb-0 md-pr-0" onSubmit={(e) => handleauthSubmit(e, login ? "signin" : "register")}>
                            <div className="flex flex-col">
                                ...
                                <div className="md:w-[356.77px] max-xs:w-[295px] h-[43.91px] flex-shrink-0 rounded-[10px] bg-bg3 mt-[10.98px] ">
                                    <input type="email" name="email" className="outline-none w-auto pt-[10.98px] pl-[16.42px] pb-[12.08px] pr-[16.42px] bg-transparent"/>
                                </div>
                            </div>
                                <div className="flex flex-col mt-[21.96px]">
                                    ...
                                    <div className="md:w-[356.77px] max-xs:w-[295px] h-[43.91px] flex-shrink-0 rounded-[10px] bg-bg3 mt-[10.98px]">
                                        <input type="password" name="password" className="outline-none w-auto pt-[10.98px] pl-[16.42px] pb-[12.08px] pr-[16.42px] bg-transparent"/>
                                    </div>
                                </div>
